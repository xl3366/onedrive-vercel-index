...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Admin@1t5gh7.onmicrosoft.com',
  ...
  links: [
    {
      name: 'qq',
      link: 'http://wpa.qq.com/msgrd?v=3&uin=178030839&site=qq&menu=yes',
    },
    {
      name: 'weixin',
      link: 'https://od.idcw.eu.org/weixin',
    },
  ],
